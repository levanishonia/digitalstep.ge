...
export const planDefinitions:Record<SubscriptionPlan,PlanDefinition>={FREE:{id:'FREE',features:['AI_ASSISTANT','POST_GENERATOR','CONTENT_CALENDAR'],limits:{AI_REQUESTS:10,POST_GENERATIONS:3}},PRO:{id:'PRO',features:['AI_ASSISTANT','POST_GENERATOR','CONTENT_CALENDAR','CONTENT_IDEAS','MARKETING_PLANNER','BUSINESS_ANALYSIS'],limits:{AI_REQUESTS:100,POST_GENERATIONS:30}},BUSINESS:{id:'BUSINESS',features:['AI_ASSISTANT','POST_GENERATOR','CONTENT_CALENDAR','CONTENT_IDEAS','MARKETING_PLANNER','BUSINESS_ANALYSIS'],limits:{AI_REQUESTS:500,POST_GENERATIONS:100}}}
