...
export function ServiceCard({service,locale}:{service:Service;locale:Locale}) {
 ...
 return <article className="service-card">
  ...
  <div className="service-body"><a className="service-title" href={`#service-${service.id}`} aria-label={`${t.home.viewService}: ${service.title[locale]}`}>{service.title[locale]}</a>
