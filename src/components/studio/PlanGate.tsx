...
const copy={ka:{locked:'ამ ფუნქციისთვის საჭიროა ფასიანი გეგმა',current:'შენი მიმდინარე გეგმა',requires:{PRO:'საჭიროა Pro გეგმა',BUSINESS:'საჭიროა Business გეგმა'},upgrade:'გეგმის განახლება'},en:{locked:'This feature requires a paid plan',current:'Your Current Plan',requires:{PRO:'Requires Pro',BUSINESS:'Requires Business'},upgrade:'Upgrade Plan'}} as const
