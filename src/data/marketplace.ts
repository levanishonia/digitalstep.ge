...
export const catalogServices: Service[] = [...popularServices,...bestsellerServices,
 ...
 extra('google-ads','Google Ads ოპტიმიზაცია','Google Ads Optimization','Next Media','advertising',4.8,91,329,3,'agency','monthly','ads',2,['popular']),
